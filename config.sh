...
find /usr/lib*/firefox/browser/extensions/ -type f -not -name 'langpack-fr*' -delete
...
zypper ar -f -n "NormandieOs(15.5)" https://download.opensuse.org/repositories/home:glaffite/15.5/ NormandieOs
...
ln -s /usr/share/applications/calamares.desktop $_HOME/Desktop/
## Set the application as being "trusted"
chmod a+x $_HOME/Desktop/calamares.desktop
...
baseUpdateSysConfig /etc/sysconfig/keyboard YAST_KEYBOARD "french,pc105"
...
_GTK_THEME="Arc-Dark"
_WM_THEME="Arc-Dark"
_WALLPAPER="/usr/share/wallpapers/zenwalk-wallpapers/bridge.jpg"
...
if rpmqpack | grep xfwm4-branding-upstream; then
...
view-as-icons=false
item-icon-size=2
favorites=firefox.desktop,thunar.desktop,xreader.desktop,org.xfce.ristretto.desktop,\
xfce-settings-manager.desktop,org.xfce.mousepad.desktop,xfce4-terminal.desktop
EOF
fi
